...
chrome.webRequest.onBeforeRequest.addListener(
  (details) => {
    if (details.url.startsWith("https://api.segment.weedmaps.com/v1")) {
      ...
      chrome.tabs.query(
        ...
        (tabs) => {
          ...
          if (details.url == "https://api.segment.weedmaps.com/v1/t") {
            event.type = "track";

            trackedEvents.unshift(event);
          } else if (details.url == "https://api.segment.weedmaps.com/v1/i") {
            event.eventName = "Identify";
            event.type = "identify";

            trackedEvents.unshift(event);
          } else if (details.url == "https://api.segment.weedmaps.com/v1/p") {
